		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<input type="hidden" id="item-id">
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Precio Compra:</label>
				    <div class="col-sm-9"> 
				      <input type="number" min="0.1" step="any" class="form-control" id="item-price-purchase" placeholder="Ingresa el precio compra" required="">
				    </div>
				  </div>
				  <div class="form-group">
			...
			-->
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Unidad Medida:</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Presentacion:</label>
				    <div class="col-sm-9"> 
